...
$(document).ready(function(){
	...
	$('.deploy-toggle-1').click(function(){
		let selectedContent = $(this).parent().find('.toggle-content');
		let hidden = selectedContent.is(":hidden");
		let exclusive = $(this).hasClass('exclusive');
		if (exclusive) {
			let grandParent = $(this).parent().parent();
			grandParent.find('.toggle-content').hide(100);
			grandParent.find('.deploy-toggle-1').removeClass('toggle-1-active');
		}
		selectedContent.toggle(hidden);
		$(this).toggleClass('toggle-1-active', hidden);
		return false;
	});
